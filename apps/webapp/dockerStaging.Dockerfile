...
ARG VITE_UNLEASH_API_CLIENT_KEY_STG
...
# Create .env file
RUN echo "VITE_API_BASE_URL=https://app.stg.rhino.energy/api/app/" > apps/webapp/.env && \
    echo "VITE_WICKET_BASE_URL=https://app.stg.rhino.energy/" >> apps/webapp/.env && \
    echo "VITE_STATIC_ASSET_URL=https://static-assets.rhino.energy/" >> apps/webapp/.env && \
    echo "VITE_UNLEASH_API_URL=https://unleash.stg.rhino.energy/api/frontend" >> apps/webapp/.env && \
    echo "VITE_UNLEASH_API_CLIENT_KEY=${VITE_UNLEASH_API_CLIENT_KEY_STG}" >> apps/webapp/.env
